package be.breina.player.dmx

import be.breina.player.dmx.animation.Animator
...
class DmxMixer(songTheming: SongTheming) {
    ...
    init {
        ...
        client.start()
        animator = Animator(songTheming) { client.unicastDmx(address, 0, 0, dmxData) }

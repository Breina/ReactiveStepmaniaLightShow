...
import be.breina.common.color.model.Image
import be.breina.common.color.model.Palette
import be.breina.common.color.model.Pixel
import be.breina.common.color.model.Region
    ...
    fun extractColors(image: Image): Palette {
        return Palette(
            image.regions.stream()
                ...
                .filter(PaletteExtractor::isColorFul)
